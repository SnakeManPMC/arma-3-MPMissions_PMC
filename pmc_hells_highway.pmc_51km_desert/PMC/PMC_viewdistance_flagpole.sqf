...
_pole addAction ["ViewDistance 3500", "PMC\PMC_viewdistance_Set.sqf", 3500];
_pole addAction ["ViewDistance 4000", "PMC\PMC_viewdistance_Set.sqf", 4000];
_pole addAction ["ViewDistance 4500", "PMC\PMC_viewdistance_Set.sqf", 4500];
...
_pole addAction ["ViewDistance 11000", "PMC\PMC_viewdistance_Set.sqf", 11000];
_pole addAction ["ViewDistance 12000", "PMC\PMC_viewdistance_Set.sqf", 12000];
_pole addAction ["ViewDistance 13000", "PMC\PMC_viewdistance_Set.sqf", 13000];
_pole addAction ["ViewDistance 14000", "PMC\PMC_viewdistance_Set.sqf", 14000];
_pole addAction ["ViewDistance 15000", "PMC\PMC_viewdistance_Set.sqf", 15000];
_pole addAction ["ViewDistance 16000", "PMC\PMC_viewdistance_Set.sqf", 16000];
_pole addAction ["ViewDistance 17000", "PMC\PMC_viewdistance_Set.sqf", 17000];
_pole addAction ["ViewDistance 18000", "PMC\PMC_viewdistance_Set.sqf", 18000];
_pole addAction ["ViewDistance 19000", "PMC\PMC_viewdistance_Set.sqf", 19000];
_pole addAction ["ViewDistance 20000", "PMC\PMC_viewdistance_Set.sqf", 20000];
