...
PMC Strike Eagle<br/>
We have been tasked to clear our enemy postions in this sector. Our Base is located
in the <marker name = 'airbase'>Airbase</marker>
<br/><br/>
First objective is to clear out city of Meaux <marker name = 'meaux'>here</marker>.<br/>
Second objective is to capture the hospital <marker name = 'hospital'>here</marker>.<br/>
Third objective is to clear montignac <marker name = 'montignac'>here</marker>.<br/>
Lastly you will unleash an attack to enemy main base <marker name = 'base'>here</marker>.<br/>
Be aware of the enemy AAA site <marker name = 'aa'>here</marker>.<br/>
