...
_z setTriggerStatements ["this", "hint 'you have won!'; player sidechat 'we have won!'; 'target1' setMarkerColor 'colorgreen'; 'target1' setMarkerType 'mil_dot'; pmc_mcomplete = true;", ""];
